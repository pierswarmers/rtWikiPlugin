      ...
      <tr>
        ...
        <td>
          <ul class="rt-admin-tools">
            <li><?php echo rt_ui_button('revert', 'rtWikiPageAdmin/Revert?id='.$rt_wiki_page->getId().'&revert_to='.$version_1, 'arrowrefresh-1-e'); ?></li>
          </ul>
        <td>
          <ul class="rt-admin-tools">
            <li><?php echo rt_ui_button('revert', 'rtWikiPageAdmin/Revert?id='.$rt_wiki_page->getId().'&revert_to='.$version_2, 'arrowrefresh-1-e'); ?></li>
          </ul>
        </td>
      </tr>
  </tbody>
...
<?php slot('rt-side') ?>
<p>
  <?php echo button_to(__('Cancel'),'rtWikiPageAdmin/versions?id='.$rt_wiki_page->getId(), array('class' => 'button cancel')) ?>
</p>
<?php end_slot(); ?>