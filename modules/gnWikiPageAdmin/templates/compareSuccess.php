      ...
      <tr>
        ...
        <td>
          <ul class="gn-admin-tools">
            <li><?php echo gn_ui_button('revert', 'gnWikiPageAdmin/Revert?id='.$gn_wiki_page->getId().'&revert_to='.$version_1, 'arrowrefresh-1-e'); ?></li>
          </ul>
        <td>
          <ul class="gn-admin-tools">
            <li><?php echo gn_ui_button('revert', 'gnWikiPageAdmin/Revert?id='.$gn_wiki_page->getId().'&revert_to='.$version_2, 'arrowrefresh-1-e'); ?></li>
          </ul>
        </td>
      </tr>
  </tbody>
...
<?php slot('gn-side') ?>
<p>
  <?php echo button_to(__('Cancel'),'gnWikiPageAdmin/versions?id='.$gn_wiki_page->getId(), array('class' => 'button cancel')) ?>
</p>
<?php end_slot(); ?>